...
* **(修正职称)**: 你选中 `Prof. XXX` 的“职称”单元格，添加评论：“[修正] XXX教授已于2024年升为 Chair Professor。”
* **(添加备注)**: 你选中 `Prof. YYY` 的“备注”单元格，添加评论：“[添加] 听学长说，XXX 2026 Fall 招 2 个 PhD，对 10043 友好。”
* **(修正主页)**: 你选中 `Prof. ZZZ` 的“主页”单元格，添加评论：“[修正] 教授的旧主页已失效，新主页是：https://...”
* **(添加新老师)**: 你选中表格最后一行的空白单元格，添加评论：“[添加教授] 地区: HongKong, 学校: HKU, 老师: XXX, ... (请提供所有信息)”
